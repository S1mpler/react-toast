    ...
    <section className="container mx-auto py-12 px-4">
      ...
      <article>
        ...
        <div className="flex justify-center gap-6 py-8 flex-wrap">
          <button className='px-4 py-2 rounded-md whitespace-nowrap bg-green-300' onClick={() => showToast({
          ...
          <button className='px-4 py-2 rounded-md whitespace-nowrap bg-yellow-300' onClick={() => showToast({
          ...
          <button className='px-4 py-2 rounded-md whitespace-nowrap bg-red-300' onClick={() => showToast({
